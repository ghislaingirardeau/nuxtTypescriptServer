<template>
  <div class="container">
    ...
    <div class="row my-5">
      <form @submit.prevent="MysqlPostData" class="row justify-content-center">
        <h1>Fetch dabatabse Mysql with POST</h1>
        <input type="number" name="idCode" id="idCode" class="col-5" />
        <div class="w-100"></div>
        <input
          type="text"
          name="denomination"
        ...
        />
        <div class="w-100"></div>
        <button type="submit" class="col-3 btn btn-primary">Post DB</button>
      </form>
    </div>
    ...
    <form @submit.prevent="sendForm" class="row justify-content-center">
      <h1 class="my-3">Form log with server</h1>
      <input type="email" name="email" id="email" class="col-5" />
      <div class="w-100"></div>
      <input type="password" name="password" id="password" class="col-5 my-3" />
      <div class="w-100"></div>
      <button type="submit" class="col-3 btn btn-primary">Login</button>
    </form>
    <div class="row">
